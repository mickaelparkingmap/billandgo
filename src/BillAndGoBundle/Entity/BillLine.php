...
class BillLine
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="BillAndGoBundle\Entity\Bill")
     * @ORM\JoinColumns({
     ...
     * @return BillLine
     */
    public function setRefBill(\BillAndGoBundle\Entity\Bill $refBill = null)
    {
     ...
     * Get refBill
     *
     * @return \BillAndGoBundle\Entity\Bill
     */
