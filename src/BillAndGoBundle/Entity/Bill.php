...
class Bill
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="BillAndGoBundle\Entity\Project", mappedBy="refBill")
     ...
     *
     * @ORM\ManyToMany(targetEntity="BillAndGoBundle\Entity\Devis", inversedBy="refBill")
     ...
     * @return Bill
     */
    public function setRefProject(\BillAndGoBundle\Entity\Project $refProject = null)
    {
     ...
     * Get refProject
     *
     * @return \BillAndGoBundle\Entity\Project
     */
     ...
     * Set client
     *
     * @param \BillAndGoBundle\Entity\Client $client
     *
     * @return Bill
     */
    public function setClient(\BillAndGoBundle\Entity\Client $client = null)
    {
        $this->client = $client;
     ...
     * Add line
     *
     * @param \BillAndGoBundle\Entity\BillLine $line
     *
     * @return Bill
     */
    public function addLine(\BillAndGoBundle\Entity\BillLine $line)
    {
        $this->lines[] = $line;
     ...
     * @param \BillAndGoBundle\Entity\BillLine $line
     */
    public function removeLine(\BillAndGoBundle\Entity\BillLine $line)
    {
     ...
     * Add refEstimate
     *
     * @param \BillAndGoBundle\Entity\Devis $refEstimate
     *
     * @return Bill
     */
    public function addRefEstimate(\BillAndGoBundle\Entity\Devis $refEstimate)
    {
     ...
     * @param \BillAndGoBundle\Entity\Devis $refEstimate
     */
    public function removeRefEstimate(\BillAndGoBundle\Entity\Devis $refEstimate)
    {
