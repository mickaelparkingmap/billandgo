...
use MyJobManagerBundle\Form\LineProjectType;
...
class ProjectController extends Controller
{
     ...
     * list all projects
     *
     * @Route("/projects", name="myjobmanager_project_list")
     ...
     *
     * @Route("/projects/{id}", name="myjobmanager_project_view", requirements={"id" = "\d+"});
     ...
     * add a project
     *
     * @Route("/projects/add", name="myjobmanager_project_add")
     * @param Request $req
     * @return \Symfony\Component\HttpFoundation\RedirectResponse|\Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @Route("/projects/create/estimate/{estimateID}", name="myjobmanager_project_create_from_estimate")
     * @param Request $req
    ...
    public function addFromEstimateAction (Request $req, int $estimateID) {
        ...
        $manager = $this->getDoctrine()->getManager();
        $estimate = $manager->getRepository('MyJobManagerBundle:Document')->find($estimateID);
    ...
    /**
     * @Route("/project/create/lines", name="myjobmanager_project_create_from_lines")
     * @param Request $req
     * @return \Symfony\Component\HttpFoundation\RedirectResponse|\Symfony\Component\HttpFoundation\Response
     */
     ...
     * delete a line
     *
     * @Route("/projects/{id}/line/{id_line}/delete", name="myjobmanager_project_line_delete")
     * @param int $id id of the project
     ...
     * @Route("/projects/{id}/line/{id_line}/edit/status/{status}", name="myjobmanager_project_line_edit_status")
     * @return \Symfony\Component\HttpFoundation\Response
     */
